                            ...
                            <>
                                <div className="p-3">
                                    <div className="card " key={index} style={{ "width": "15rem" }}>
                                        <img src={`https://starwars-visualguide.com/assets/img/characters/${index + 1}.jpg`} alt="" width="100%" classNameName="img-fluid grayscale" />
                                        <div className="card-body">
                                            <h5 className="card-title text-center pb-3">{value.name}</h5>
                                                
                                            <div className="row px-3">
                                                <Link to={`/personajes/${index + 1}`} className="btn btn-primary">More info</Link>
